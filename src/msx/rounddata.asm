...
ENEMY_PTN_ROUND01:
    DW $0000
    DB CHRNO_ENEMY3, 120, 200, DIRECTION_LEFT, $00, $00
    DW $0000
    DB CHRNO_ENEMY3,  56,  40, DIRECTION_RIGHT, $00, $00
    DW $FFFF
...
ENEMY_PTN_ROUND03:
    DW $0000
    DB CHRNO_ENEMY3, 120, 200, DIRECTION_RIGHT, $00, $00
    DW $0000
    DB CHRNO_ENEMY3,  56,  40, DIRECTION_LEFT, $00, $00
    DW $FFFF
